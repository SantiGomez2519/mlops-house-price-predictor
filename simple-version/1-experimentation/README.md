...
| 2 | `1_2_data_raw_train_preprocessing.ipynb` | Clean **train only** (duplicates, missing `price`, impute) | `data/data_preprocessed_train.csv`, `models/preprocessor.pkl` |
...
| 6 | `1_6_data_raw_test_evaluation.ipynb` | Apply saved artifacts to test (`transform`/`predict` only) | `data/data_test_predictions.csv` |
